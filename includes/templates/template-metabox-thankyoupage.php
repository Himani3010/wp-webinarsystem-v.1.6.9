...
<div id="tnxp-accordian" class="ws-accordian">
    ...
    <div class="ws-accordian-section">
        ...
        <div class="form-field">
            ...
            <p class="description tnxp_vidurl_desc tnxp_vidurl_for_youtube" style="<?php echo (empty($tnxp_vidurl_type) || $tnxp_vidurl_type == 'youtube') ? '' : 'display:none'; ?>"><?php _e('Paste Youtube URL here (Eg: https://www.youtube.com/watch?v=3TkeXaMpLe9-XM)', WebinarSysteem::$lang_slug); ?></p>
        ...
        <div class="form-group">
            ...
            <input type="checkbox" data-switch="true" name="tnxp_video_auto_play_yn" id="tnxp_video_auto_play_yn" value="yes" <?php echo ($tnxp_video_auto_play_yn_value == "yes" ) ? 'checked="checked"' : ''; ?> >
            <p class="description">YouTube / Vimeo only.</p>
            <div class="webinar_clear_fix"></div>
        </div>
        
        <div class="form-group">
            <label for="tnxp_video_controls_yn"><?php _e('Video Controls', WebinarSysteem::$lang_slug); ?></label>
            <?php $tnxp_video_controls_yn_value = get_post_meta($post->ID, '_wswebinar_tnxp_video_controls_yn', true); ?>
            <input type="checkbox" data-switch="true" name="tnxp_video_controls_yn" id="tnxp_video_controls_yn" value="yes" <?php echo ($tnxp_video_controls_yn_value == "yes" ) ? 'checked' : ''; ?> >
    ...
    <div class="ws-accordian-section">
        ...
        <div class="form-group">
            <label for="tnxp_social_sharing_yn"><?php _e('Show social share box', WebinarSysteem::$lang_slug); ?></label>
            <?php $tnxp_social_sharing_yn_value = get_post_meta($post->ID, '_wswebinar_tnxp_social_sharing_yn', true); ?>
            <input data-style-collect="true" type="checkbox" data-switch="true" name="tnxp_social_sharing_yn" id="tnxp_video_controls_yn" value="yes" 
                <?php echo ($tnxp_social_sharing_yn_value == "yes" || empty($tnxp_social_sharing_yn_value)) ? 'checked="checked"' : ''; ?> >
            <div class="webinar_clear_fix"></div>
        </div>      
